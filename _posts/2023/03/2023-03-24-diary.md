...
やるか。[FOUR CURSES(アルファ版)][dtp23a] を。パンデモニウム突撃。脱出。
パンデモニウム強制送還の繰り返して（バグ）ラスボスに到着。
途中でキャラクターが変わらなくなる不具合もある。これは無理だ。やめよう。

魔剣士なしで進んでみる。仲間を攻撃する呪いにかかったビビアンにデスマーク装備を付けていてえらい目に遭う。
あとは特に新しいイベントもなくグルグル回るしかないようだ。あとは完成版に期待。
